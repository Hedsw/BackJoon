...
public class problem_10828 {
  ...
  Stack<Integer> st = new Stack<>();
    int Count,push_int; // 명령어 개수 체킹, push 할 숫자 체킹
    String instructor; // 무슨 명령어 받을지 결정
      ...
      Count = keyboard.nextInt();
        ...
        for(int i = 0; i < Count; i++) {
          ...
          if(instructor.equals("push")) {
            push_int = keyboard.nextInt();
              st.push(push_int);
          }
          else if(instructor.equals("pop")) {
            try {
          ...
          else if(instructor.equals("size")) {
              System.out.println(st.size());
          }
          else if(instructor.equals("top")) {
            try {
          ...
          else if(instructor.equals("empty")) {
